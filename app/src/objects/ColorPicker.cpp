...
bool ColorPicker::update_picker(std::pair<Sprite *, std::string> picker) {
    ...
    Settings::save(picker.second+"_r", new_color.x*1000.0f);
    Settings::save(picker.second+"_g", new_color.y*1000.0f);
    Settings::save(picker.second+"_b", new_color.z*1000.0f);
