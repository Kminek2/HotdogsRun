...
CarInputs::CarInputs(CarMovement& script, uint16_t forward_key, uint16_t backwards_key, uint16_t left_turn_key, uint16_t right_turn_key, uint16_t hand_break_key) 
: script(script), forward_key(forward_key), backwards_key(backwards_key), left_turn_key(left_turn_key), right_turn_key(right_turn_key), hand_break_key(hand_break_key)
{}
